...
class AddCustomer:
    # Add customer Page
    lnkCustomers_menu_xpath = "//a[contains(@href,'#')]//p[contains(text(),'Customers')]"
    lnkCustomers_menuitem_xpath = "//a[contains(@href,'/Admin/Customer/List')]//p[contains(text(),'Customers')]"
